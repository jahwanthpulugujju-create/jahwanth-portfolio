...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <motion.div
      ...
      data-cursor="expand"
      style={{
        background: "var(--deep-green)", height: 360, display: "flex",
    ...
    >
      <div>
        ...
        <h3 style={{
          ...
          color: "var(--cream)", fontWeight: 700, lineHeight: 1.15, margin: "0 0 16px",
        }}>
          {project.title}
        </h3>
        <p style={{
          fontSize: 15, color: "rgba(245,240,232,0.7)", lineHeight: 1.6,
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
        <div style={{ fontSize: 13, color: "rgba(245,240,232,0.5)", fontFamily: "'DM Sans', sans-serif" }}>
