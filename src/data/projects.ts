...
export const projects: Project[] = [
  {
    ...
    description:
      "Built the full brand identity from ground up , logo philosophy, color palette, typography, Instagram visual language, content pillars, and growth strategy. Sole designer and strategist throughout.",
    ...
    links: [
      {
        ...
        url: "https://drive.google.com/drive/folders/13pzD6hyebdegqyj_L8J4gonft8e6r-PA",
      },
    ],
    mediaPlaceholders: 4,
    featured: true,
  },
  {
    ...
    description:
      "Designed and executed the entire creative campaign , event poster series, social media content across Instagram and WhatsApp, narrative copywriting, event identity, and on-ground experience design for the Toastmasters murder mystery evening.",
  ...
  },
  {
    ...
    description:
      "Planned and ran the complete multi-channel marketing campaign across Instagram, WhatsApp, and campus networks for the Praxis 2026 entrepreneurship event at BVRIT.",
  ...
  },
  {
    ...
    description:
      "Designed the complete event architecture for Brand Wars 2026 , scheduling, rules framework, judging parameters, volunteer roles, and live execution plan. Anchored coordination throughout.",
